	...
	if($con!=null)
	{
		...
		if($db!=null)
		{
			...
			if($id == 0)
			{
				$mactd = $_POST['mactd'];
				$socu = $_POST['socu'];
				$result = mysql_query("INSERT INTO congtodien( mactd, socu) VALUES ('".$mactd."',".$socu.")");
			}
			else
			{
				$socu = $_POST['somoi'];
				$result = mysql_query("UPDATE congtodien SET somoi = '".$somoi." WHERE id = ".$id);
			}
			header("Location: qlcongtoien.php");
		}
	}
}
else
