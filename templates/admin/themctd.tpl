...
<div class="noidung">
	<div>
		...
		<div class="chinh">
		<div>
			<form class="form" action="themctd.php?id={ctd.id}" method="POST">
				<div class="form-group">
					<label>Mã Công Tơ Điện</label>
				</div>
				<div class="form-group">
					<input class="form-control" type="text" name="mactd" placeholder="Nhập mã công tơ điện..." value="{ctd.mactd}"/>
				</div>
				<div class="form-group">
					<label>Số Cũ</label>
				</div>
